...
public class CameraModuleZxing extends ReactContextBaseJavaModule {

    private final CameraPermission cameraPermission;
    private Promise checkPermissionStatusPromise;

    public CameraModuleZxing(ReactApplicationContext reactContext) {
        super(reactContext);
