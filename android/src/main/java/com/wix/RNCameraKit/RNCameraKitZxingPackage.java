...
public class RNCameraKitZxingPackage implements ReactPackage {
    ...
    public RNCameraKitZxingPackage() {

    }

    public RNCameraKitZxingPackage(CameraPermissionRequestCallback cameraPermissionRequestCallback, StoragePermissionRequestCallback storagePermissionRequestCallback) {
    ...
    public List<NativeModule> createNativeModules(ReactApplicationContext reactContext) {
        ...
        CameraModuleZxing cameraModuleZxing = new CameraModuleZxing(reactContext);
        if (cameraPermissionRequestCallback != null) {
            cameraPermissionRequestCallback.setCameraModuleZxing(cameraModuleZxing);
        }
        modules.add(cameraModuleZxing);
